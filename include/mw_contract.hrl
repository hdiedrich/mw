...
%% Abort events
-define(CONTRACT_STATE_DESC_GIVER_ABORT_BEFORE_T1, "Giver aborted before her T1.").
-define(CONTRACT_STATE_DESC_TAKER_ABORT_BEFORE_T1, "Taker aborted before her T1.").
...
-define(CONTRACT_STATE_DESC_GIVER_ABORT_AFTER_T1, "Giver aborted after her T1.").
-define(CONTRACT_STATE_DESC_TAKER_ABORT_AFTER_T1, "Taker aborted after her T1.").
